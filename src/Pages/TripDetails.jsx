    ...
    <>
      ...
      <div className=" bg-white  rounded-lg shadow p-4 m-5 ">
        <p className="mb-5 text-base text-bodycolor md:mt-4 sm:text-lg  text-right">
          رحلتي إلى شرم الشيخ كانت تجربة لا تُنسى. بدأت المغامرة بالطيران إلى
          هذا الجمال الساحر المطل على البحر الأحمر. بمجرد وصولي، استقبلني مناظر
          الطبيعة الخلابة والشواطئ الرملية البيضاء. استمتعت بالغوص وسط الشعاب
          المرجانية الملونة ورؤية الأسماك المتنوعة. كما قضيت أوقاتاً رائعة في
          زيارة السوق المحلي وتجربة المأكولات البحرية الشهية. في المساء، استمتعت
          بحفلات الشاطئ والأجواء الاحتفالية التي تضفي سحراً خاصاً على المدينة.
          كانت الرحلة مزيجاً من الاسترخاء والمغامرة، وأتطلع للعودة مرة أخرى.
        </p>
      </div>
