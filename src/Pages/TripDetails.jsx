    ...
    return (
        ...
        <>
            ...
            <div className="flex flex-col md:flex-row items-start justify-center  space-y-5 md:space-y-0 md:space-x-8 p-4">
                <div className="flex flex-col items-center p-4 md:ml-[20%] bg-gray-100 rounded-lg border border-gray-300 max-w-xs md:order-1">
                    ...
                    <div className="grid grid-cols-5 gap-2">
                        {seats.map((seat, index) => (
                            <div
                                key={index}
                                className={`w-10 h-10 flex items-center justify-center rounded-md ${seat.status === "available"
                ...
                <div className="flex flex-col-reverse md:flex-col items-start space-y-5 md:space-y-0 p-4 ">
                  
                    <div className="bg-white rounded-3xl shadow  w-80 md:mb-8 order-1 ">
                        <p className="mb-5 text-base text-black md:mt-4 sm:text-lg text-center">
                            سعر الكرسي <span className="text-price">80</span> جنيه مصري
                        </p>
                    </div>

                    
                    <div className="bg-white rounded-3xl shadow p-4 w-80 border border-price md:order-2 ">
