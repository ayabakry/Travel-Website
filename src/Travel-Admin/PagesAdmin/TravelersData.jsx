  ...
  return (
    <>
      <div className="container w-full md:w-[calc(100%-270px)] lg:w-[calc(100%-280px)] pt-16 md:pr-8 pr-2 lg:pr-10 md:ml-2 md:mr-[270px] md:mt-8 lg:mr-[280px]">
        <div class="flex items-center space-x-4 md:ml-8 ml-2">
          <div class="flex items-center bg-price rounded-lg p-0.5 w-fit">
          ...
          <div class="max-w-xl flex-1 p-4">
            <div class="relative">
              <input
                type="search"
                placeholder="البحث هنا"
                class="w-full md:w-auto h-12 pl-12 pr-4 rounded-xl bg-white shadow-sm border-0 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-200 transition-shadow text-right"
                dir="rtl"
              />
        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
          ...
          >
            <thead className="md:text-base text-white uppercase  bg-primaryTitle ">
              <tr>
                <th scope="col" className="px-8 py-3  w-10 font-sans ">
                  الرحلة
                </th>
            ...
            <tbody>
              ...
              >
                <td className="px-4">شرم الشيخ</td>
                ...
                <td className="px-6 py-4  font-sans">
                  <label>
                    ...
                    >
                      <path
                        d="M3.35788 19.01L3.33788 19.03C3.06788 18.44 2.89788 17.77 2.82788 17.03C2.89788 17.76 3.08788 18.42 3.35788 19.01Z"
                        fill="#8EC640"
                      />
                      <path
                        d="M9.77795 10.38C11.0924 10.38 12.1579 9.31443 12.1579 8C12.1579 6.68556 11.0924 5.62 9.77795 5.62C8.46351 5.62 7.39795 6.68556 7.39795 8C7.39795 9.31443 8.46351 10.38 9.77795 10.38Z"
                        fill="#8EC640"
                      />
                      <path
                        d="M16.9678 2H8.58783C4.94783 2 2.77783 4.17 2.77783 7.81V16.19C2.77783 17.28 2.96783 18.23 3.33783 19.03C4.19783 20.93 6.03783 22 8.58783 22H16.9678C20.6078 22 22.7778 19.83 22.7778 16.19V13.9V7.81C22.7778 4.17 20.6078 2 16.9678 2ZM21.1478 12.5C20.3678 11.83 19.1078 11.83 18.3278 12.5L14.1678 16.07C13.3878 16.74 12.1278 16.74 11.3478 16.07L11.0078 15.79C10.2978 15.17 9.16783 15.11 8.36783 15.65L4.62783 18.16C4.40783 17.6 4.27783 16.95 4.27783 16.19V7.81C4.27783 4.99 5.76783 3.5 8.58783 3.5H16.9678C19.7878 3.5 21.2778 4.99 21.2778 7.81V12.61L21.1478 12.5Z"
                        fill="#8EC640"
                      />
                    </svg>
                  </label>
                ...
                <td className="px-6 py-4  font-sans">
                  <div class="flex ">
                    <form class="max-w-sm">
                      <select
                        id=""
                        class=" border border-2 border-primaryTitle text-primaryTitle text-sm rounded-lg focus:ring-primaryTitle focus:border-primaryTitle  w-full p-1 "
                      >
                        <option selected>تم التأكيد</option>
                        <option value="US">ملغي</option>
                        <option value="CA">إنتظار الدفع</option>
                        <option value="FR">تم الدفع</option>
                ...
                <td>
                  <p>الحجز 17 / 11 / 2024</p>
                  <p>الدفع 18 / 11 / 2024</p>
                </td>
                <td className="px-6 py-4  font-sans">
                  <div className="flex">
                    <svg
