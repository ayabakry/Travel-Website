              ...
              <div className="bg-white rounded-3xl shadow p-4 w-80 border md:mt-2 border-price md:order-3 pt-4 ">
                ...
                <form className="max-w-sm mx-auto">
                  <div className="flex items-center relative">
                    <input
                      type="text"
                      className="text-right rounded-3xl bg-gray text-gray-900 pr-12 block flex-1 min-w-0 w-full text-sm p-2.5 placeholder-placeholder focus:text-price focus:border focus:border-price focus:outline-none focus:bg-white"
                      placeholder="إدخل الاسم الثنائي هنا"
                    />
                  ...
                  <div className="flex items-center relative">
                    <input
                      type="text"
                      className="text-right rounded-3xl bg-gray text-gray-900 pr-12 block flex-1 min-w-0 w-full text-sm p-2.5 placeholder-placeholder focus:text-price focus:border focus:border-price focus:outline-none focus:bg-white"
                      placeholder="إدخل الايميل الخاص بك هنا (إختياري)"
                    />
                    <span className="absolute right-3 flex items-center">
                      <svg
                        width="25"
